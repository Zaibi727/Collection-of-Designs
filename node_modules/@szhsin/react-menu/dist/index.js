...
var SUBMENU_CLOSE_DELAY = 160;
var SUBMENU_OPEN_DELAY = 160;
...
var MenuList = defineName( /*#__PURE__*/React__default.memo(function MenuList(_ref) {
  ...
  var _useContext = React.useContext(SettingsContext),
      ...
      menuRootRef = _useContext.menuRootRef,
  ...
  var reposFlag = React.useContext(MenuListContext) || repositionFlag;
  ...
  var menuItems = React.useMemo(function () {
    ...
    var items = React__default.Children.map(children, function (child) {
      ...
      var componentName = getName(child.type);
  ...
  var positionHelpers = React.useCallback(function (boundingBoxRef, boundingBoxPadding) {
  ...
  var handlePosition = React.useCallback(function () {
    ...
    var helpers = positionHelpers(boundingBoxRef, boundingBoxPadding);
  ...
  React.useEffect(function () {
    ...
    var target = scrollingRef.current.addEventListener ? scrollingRef.current : window;
...
var Menu = /*#__PURE__*/React__default.memo(function Menu(_ref) {
  var ariaLabel = _ref['aria-label'],
      ...
      restProps = _objectWithoutPropertiesLoose(_ref, ["aria-label", "id", "animation", "boundingBoxRef", "boundingBoxPadding", "captureFocus", "debugging", "reposition", "viewScroll", "keepMounted", "menuButton", "portal", "theming", "onClick", "onChange"]);
...
var ControlledMenu = /*#__PURE__*/React__default.memo(function ControlledMenu(_ref) {
  var ariaLabel = _ref['aria-label'],
      ...
      onClick = _ref.onClick,
      onClose = _ref.onClose,
      restProps = _objectWithoutPropertiesLoose(_ref, ["aria-label", "id", "animation", "boundingBoxRef", "boundingBoxPadding", "debugging", "reposition", "viewScroll", "portal", "theming", "isMounted", "onClick", "onClose"]);
