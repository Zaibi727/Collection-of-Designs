        ...
        {/*--social-media--*/}
           ...
           <section className={styles.lastportion}>
                         <div className={styles.tabdivsecond}>
                             <p classNam={styles.ttt}   style={ show ? {marginBottom: '0px', paddingBottom: '6px', color: 'rgb(153, 149, 149)', borderBottom: 'none', width: '50%', textAlign: 'center', fontSize: '16px'} : {marginBottom: '0px', paddingBottom: '6px', color: 'black', borderBottom: '2px solid black', width: '50%', textAlign: 'center', fontSize: '16px'}} className={styles.left} onClick={tabClose}>{data.tableft}</p>
                             <p classNam={styles.ttt}    style={ show ? {marginBottom: '0px', paddingBottom: '6px', color: 'black', borderBottom: '2px solid black',width: '50%', textAlign: 'center', fontSize: '16px'} : {marginBottom: '0px', paddingBottom: '6px', color: 'rgb(153, 149, 149)', borderBottom: 'none',width: '50%', textAlign: 'center', fontSize: '16px'}} className={styles.right} onClick={tabOpen}>{data.tabright}</p>
                         </div>
