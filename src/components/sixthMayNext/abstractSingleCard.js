 ...
 const AbstractSingleCard = (props) => {
  ...
  return (
            ...
            <div className={styles.abstractWrapper} >
                 <div className={styles.abstarctDiv1}  onClick={onClick} style={style}>
                     <img className={styles.abstarctImg} src={src} />
                 </div>

                 <div className={styles.abstarctDiv2} onClick={onClick} style={style}>
                   <p className={styles.name}>{name}</p>
                   <p className={styles.adress}>{address}</p>
                 </div>

                 <div className={styles.abstarctDiv3} onClick={onClick} style={style}>
                     <div>
