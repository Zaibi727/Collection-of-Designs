        ...
        <div className={styles.sidenav}>
          ...
          <Router>
              <ul className={styles.div2}>
                  ...
                  <li className={styles.about} onClick={this.handleButtonOneClick} style={{backgroundColor: this.state.open == true && "#f3f4f6", borderLeft: this.state.open == true && '5px solid red', PaddingTop: this.state.open == true && '20px', paddingBottom: this.state.open == true && '20px'}}>
                  ...
                  <li className={styles.another} onClick={this.handleButtonTwoClick} style={{backgroundColor: this.state.opene == true && "#f3f4f6", borderLeft: this.state.opene == true && '5px solid red',PaddingTop: this.state.open == true && '20px', paddingBottom: this.state.open == true && '20px'}}>
