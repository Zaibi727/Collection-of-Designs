...
const sideItems = [ 
        ...
        {  itemid: '/fitness-dashboard',  name: 'fitness dashboard', label: 'Fitness Dashboard', Icon: <FiLogOut /> },
        {
            ...
            content: [
                { name: 'light theme', label: 'Light Theme' },
                { name: 'dark theme', label: 'Dark Theme' },
            ]
        },

        { name: 'logout', label: 'Log out', Icon: <FiLogOut/> },
        ...
        {  name: 'mail app', label: 'Mail Application',Icon: <FiMail /> },
        {  name: 'chat app', label: 'Chat Application',Icon: <BsFillChatFill /> },
        {  name: 'todo app', label: 'Todo Application',Icon: <SiTodoist /> },
        ...
        {name: 'logout', label: 'Log Out',Icon: <BiLogIn />},
        {name: 'documentation', label: 'Documentation',Icon: <TiDocumentText />}
